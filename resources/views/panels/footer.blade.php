...
<footer class="footer footer-light {{($configData['footerType'] === 'footer-hidden') ? 'd-none':''}} {{$configData['footerType']}}">
  <p class="clearfix mb-0">
    ...
    <span class="float-md-end d-none d-md-block">Rafli Sodri <span  data-bs-toggle="tooltip" data-bs-placement="top" title="Giselaaa 😉">  <i data-feather="heart" ></i>  </span> </span>
  </p>
</footer>
