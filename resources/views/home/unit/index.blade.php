...
@section('title', 'Halaman Unit Bisnis')
...
<div class="card-header">
    ...
    <form action="{{route('unit.store')}}" method="POST" class="w-100">
        @csrf
...
<script>
    $('.nonaktif').on('click', function () {
        ...
        Swal.fire({
            ...
            text: "Anda akan menonaktifkan unit ini",
            icon: 'info',
            ...
            if (result.isConfirmed) {
                window.location.href= "{{ route('unit.off', '') }}" + '/' + btnId;
            }
        });
    });
</script>
...
<script>
    $('.aktif').on('click', function () {
        ...
        Swal.fire({
            title: 'Apakah anda yakin?',
            text: "Anda akan menaktifkan unit ini",
            icon: 'info',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.isConfirmed) {
                window.location.href= "{{ route('unit.on', '') }}" + '/' + btnId;
            }
        });
    });
</script>
...
<script>
    $('.btnDelete').on('click', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href= "{{ route('unit.destroy', '') }}" + '/' + btnId;
            }
        });
    });
</script>
